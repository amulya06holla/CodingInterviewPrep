...
//https://leetcode.com/submissions/detail/527889456/
public class WordLadder2 {
    ...
    private void backtrack(String source, String destination) {
        ...
        for (int i = 0; i < adjList.get(source).size(); i++) {
            ...
            currPath.remove(currPath.size() - 1); // we are removing the end word from the path that we have formed. so that we can backtrack and find the next possible path
        }
    }
