...
public class SlidingPuzzle {
    public int slidingPuzzle(int[][] board)
    {
        ...
        StringBuilder sB= new StringBuilder();//String Buffer because it takes O(1) time for string creation
        for(int i= 0; i< 2; i++){
            for(int j= 0; j< 3; j++)
                sB.append(board[i][j]);
        }
        String start= sB.toString();//Intial puzzle given
        ...
        //TO UNDERSTAND THE BELOW ARRAY VALUES, CHECK THE VIDEO IN THE COMMENT ABOVE. IT HAS GOOD EXPLANATION
